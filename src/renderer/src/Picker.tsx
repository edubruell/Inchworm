 ...
 *
 * The door, and no more than the door: the agent runs in a **window of its
 * own** (`AgentWindow`), because this panel is also mounted in the picker
 * *sheet*, over a window that already has a project — and a terminal opened
 * there looked for all the world like an agent running inside that project.
 * Main opens the window on the folder it refused; the renderer names no
 * directory, here or anywhere.
 */
const Bootstrap = (props: {
  ...
  /** Report a bridge failure the way every other button in the picker does. */
    ...
    >
      ...
      <div class="flex items-center gap-2">
        <button
          ...
          onClick={() => {
            props.api.openAgentWindow().catch((error: unknown) => {
